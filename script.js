...
var btnRemove2 = document.querySelector('.remove');
btnPlay.addEventListener('click', () => {
  btnRemove2.classList.add('hiden');
  board.reset();
...
document.querySelector('.remove-btn1').addEventListener('click', () => {
  brick.moveLeft();
})
document.querySelector('.remove-btn2').addEventListener('click', () => {
  brick.moveRight();
})
document.querySelector('.remove-btn4').addEventListener('click', () => {
  brick.moveDown();
})
document.querySelector('.remove-btn3').addEventListener('click', () => {
  brick.rotate();
})
var deleteSound = document.querySelector('.delete-sound');
deleteSound.addEventListener('click', () => {
  deleteSound.classList.toggle('green');
})
// brick.moveLeft();
// brick.moveDown();
// brick.moveRight();
